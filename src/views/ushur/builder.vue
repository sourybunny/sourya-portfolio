<template>
          ...
          <v-layout wrap class="align-start justify-space-between">
              ...
              <v-layout wrap class="align-start justify-space-between mt-4">
                <v-flex xs12 sm6>
                  <section-content :title="'Problem'">
                    <div>
                      Usability issues in core feature of the interface affecting task completion time and causing drop-off
                    </div>
                  </section-content>
                </v-flex>
                <v-flex xs12 sm5>
                  <section-content :title="'Outcome'">
                    <div>
                      I redesigned the interface solving major usability issues that increased user satisfaction
                    </div>
                  </section-content>
                </v-flex>
              </v-layout>
            ...
            <v-flex xs3>
              ...
              <sectionContent :title="'Role'">
                <div>
                  UX Designer (Ideation, concept design, visual
                  design)
                </div>
              </sectionContent>
        ...
        <section class="inner-section">
          ...
          <section-overview :title="'Who is it for?'">
            <div>
              ...
              insurance claim submission etc. 
            </div>
          </section-overview>
          <v-img
            class="mx-auto mt-4"
  ...
  export default {
    ...
    data: () => {
      return {
        project_desc: "Improving usability of no-code tool for developers",
        show_process: false
      };
    },
  };
