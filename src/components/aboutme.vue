      ...
      <v-layout row xs12 wrap>
        <v-flex xs12 md6>
          <div class="pl-3">
            ...
            <p class="font-weight-light mt-8 body-1">
            ...
            <p class="font-weight-light mt-4 body-1">
              In the past, I’ve worked in multiple roles at
              <strong class="primary--text font-weight-medium">
        ...
        <v-flex :order="$vuetify.breakpoint.xsOnly?1:2" xs12 md6 :right-align="!$vuetify.breakpoint.mobile">
          <h1>image</h1>
        </v-flex>
      </v-layout>
